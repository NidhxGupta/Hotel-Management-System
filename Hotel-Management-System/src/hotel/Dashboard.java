...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/goa.jfif"));
        Image i2 = i1.getImage().getScaledInstance(910, 612,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 910, 612); 
        add(NewLabel);
